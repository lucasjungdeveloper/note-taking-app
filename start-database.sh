...
DB_CONTAINER_NAME="note-taking-app-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=note-taking-app -d -p 5432:5432 docker.io/postgres
